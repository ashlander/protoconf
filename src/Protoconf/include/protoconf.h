...
class protoconf {
   ...
   public:
       ...
       * @return Success
       */
      static bool readEntireFile(const std::string& path, std::string& output)
      {
       ...
       * @return Success
       */
      static bool writeEntireFile(const std::string& path, const std::string& output)
      {
      ...
      template<class TProtoConf>
         static bool toJson(const TProtoConf& conf, std::string& output)
         {
       ...
       */
      template<class TProtoConf>
         static bool fromJson(const std::string& json, TProtoConf& conf, bool ignoreMissing = true)
         {
            using namespace google::protobuf;
       ...
       */
      template<class TProtoConf>
         static bool save(const std::string& path, const TProtoConf& conf)
         {
            bool result = true;
       ...
       */
      template<class TProtoConf>
         static bool load(const std::string& path, TProtoConf& conf, const TProtoConf& templateConfiguration = TProtoConf(), bool ignoreMissing = true, bool createTemplateIfMissing = true)
         {
            bool result = true;
